...
class EvaluationHistoryPage(QWidget):
            ...
            icon_container.setStyleSheet(f'''
                QFrame {{
                    background: qlineargradient(x1:0, y1:0, x2:1, y2:1,
                        stop:0 {color}40, stop:0.5 {color}25, stop:1 {color}10);
                    border-radius: 24px;
        ...
        try:
            ...
            for eval_data in db_evaluations:
                formatted = {
                    ...
                    "cropname": eval_data.get("crop_id", "").replace("_", " ").title(),
    ...
    def refresh(self):
        ...
        print("🔄 Refreshing Evaluation History...")
        self.load_history()
    ...
    def populate_table(self):
        ...
        for row_idx, eval_data in enumerate(self.filtered_data):
            ...
            # Crop Name
            crop_item = QTableWidgetItem(eval_data["cropname"])
    ...
    def delete_evaluation(self, eval_data):
        ...
        reply = QMessageBox.question(
            self,
            "Confirm Delete",
            f"Are you sure you want to delete the evaluation for {eval_data['cropname']}?",
